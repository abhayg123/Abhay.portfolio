        ...
        // Fade-in animation for Graphics Projects
const graphicsCards = document.querySelectorAll('.graphics-card');

function checkGraphicsScroll() {
...
// Initialize graphics cards with fade-in effect
graphicsCards.forEach(card => {
...
window.addEventListener('scroll', checkGraphicsScroll);
window.addEventListener('load', checkGraphicsScroll);

// mycode

// hidden div से text पढ़ें
var typed_strings = document.getElementById('abhay').textContent;

// Typed.js initialize करें
